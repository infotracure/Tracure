...
class FastingTrackerWeek extends StatefulWidget {
  const FastingTrackerWeek({super.key});

  @override
  State<FastingTrackerWeek> createState() => _FastingTrackerWeekState();
}

class _FastingTrackerWeekState extends State<FastingTrackerWeek> {
  final fastingData = [10.0, 0.0, 5.0, 14.0, 0.0, 0.0, 0.0];
  @override
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 8),
              SizedBox(height: 150, child: WeekBarChart(data: fastingData)),
            ],
          ),
        ),
