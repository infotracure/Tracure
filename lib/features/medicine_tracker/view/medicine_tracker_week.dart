...
class MedicineTrackerWeek extends StatefulWidget {
  const MedicineTrackerWeek({super.key});

  @override
  State<MedicineTrackerWeek> createState() => _MedicineTrackerWeekState();
}

class _MedicineTrackerWeekState extends State<MedicineTrackerWeek> {
