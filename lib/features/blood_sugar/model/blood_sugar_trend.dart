...
BloodSugarTrendModel bloodSugarTrendModelFromJson(String str) => BloodSugarTrendModel.fromJson(json.decode(str));

String bloodSugarTrendModelToJson(BloodSugarTrendModel data) => json.encode(data.toJson());
...
class BloodSugarTrendModel {
    ...
    factory BloodSugarTrendModel.fromJson(Map<String, dynamic> json) => BloodSugarTrendModel(
        code: json["code"],
