...
class BloodSugarWeek extends StatefulWidget {
  const BloodSugarWeek({super.key});

  @override
  State<BloodSugarWeek> createState() => _BloodSugarWeekState();
}

class _BloodSugarWeekState extends State<BloodSugarWeek> {
